...
namespace BookStoreApi.Migrations
{
    ...
    [Migration("20250307020726_Add WishList y WishListDetails")]
    partial class AddWishListyWishListDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStoreApi.Models.WishList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStoreApi.Models.WishListDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStoreApi.Models.WishList", b =>
                {
                    b.HasOne("BookStoreApi.Models.User", "User")
                        .WithOne("WishList")
                        .HasForeignKey("BookStoreApi.Models.WishList", "IdUser")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BookStoreApi.Models.WishListDetails", b =>
                {
                    ...
                    b.HasOne("BookStoreApi.Models.WishList", "WishList")
                        .WithMany("WishListDetails")
